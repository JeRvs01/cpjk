...
<li id="new"><a href="#" onclick="formSubmit('importInfo.action','_self');this.blur();">导入</a></li>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>
			...
			<c:if test="${o.state==1}"><a href="stop.action?id=${o.id}"><font color="orange">启用</font></a></c:if>
		</td>
	</tr>
	</c:forEach>
